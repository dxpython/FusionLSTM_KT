...
from model.lstm_Transformer import LSTM_Transformer_Model
...
num_heads = 8
output_dim = 228
model = LSTM_Transformer_Model(input_dim, hidden_dim, lstm_layers, transformer_layers, num_heads, output_dim).to(device)
