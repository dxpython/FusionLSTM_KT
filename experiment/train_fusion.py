...
from model.Fusion import LSTM_Attention_KAN_Transformer
...
num_heads = 8  
output_dim = 228
model = LSTM_Attention_KAN_Transformer(input_dim, hidden_dim, lstm_layers, transformer_layers, num_heads, output_dim, knowledge_dim, dropout=0.3).to(device)
...
for epoch in range(epochs):
    ...
    for batch, knowledge_batch in create_batches(x_data_windows, knowledge_data, batch_size):
        ...
        outputs, _ = model(batch, knowledge_batch)
